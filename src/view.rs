...
fn render_dashboard(ui: &mut egui::Ui, state: &mut AppState, ctrl: &Controller) {
    ...
    let (title, sub) = match state.dashboard_tab {
        ...
        DashboardTab::AboutUs => ("Tentang Kami", "Vault Defender · Tim Pengembang".to_string()),
...
fn render_tab_about_us(ui: &mut egui::Ui, state: &mut AppState, _ctrl: &Controller) {
    ...
    // ── App Name & Version ──
    ui.vertical_centered(|ui| {
        ui.label(egui::RichText::new("Vault Defender").size(28.0).color(text_primary()).strong());
        ui.add_space(4.0);
    ...
    // ── Footer ──
    ui.vertical_centered(|ui| {
        ui.label(egui::RichText::new("© 2025 Vault Defender Team").size(11.0).color(text_muted()));
        ui.add_space(4.0);
                ...
                ui.vertical_centered(|ui| {
                    ...
                    egui::Frame::none()
                        ...
                        .show(ui, |ui| {
                            ...
                            ui.vertical(|ui| {
                                ui.label(egui::RichText::new("Aplikasi Vault Defender tidak dapat dijalankan pada perangkat yang di-Root atau di dalam Emulator karena rentan terhadap penyadapan dan manipulasi memori demi keamanan data sensitif Anda.").size(13.0).color(text_body()));
                                ui.add_space(14.0);
        ...
        egui::Area::new(egui::Id::new("storage_path_modal"))
            ...
            .show(ctx, |ui| {
                ...
                ui.allocate_new_ui(egui::UiBuilder::new().max_rect(modal_rect.shrink(24.0)), |ui| {
                    ...
                    ui.painter().text(egui::pos2(i2.right()+12.0, r2.center().y + 10.0), egui::Align2::LEFT_CENTER, "/sdcard/VaultDefender/ · Penyimpanan eksternal", FontId::new(11.0, FontFamily::Proportional), text_muted());
                    if is_sdcard {
                    ...
                    ui.horizontal(|ui| {
                        ...
                        if teal_btn(ui, "Simpan", (w - 12.0)*0.6).clicked() {
                            ...
                            if state.storage_location_type == 0 {
                                ...
                                state.storage_path = "/sdcard/VaultDefender/ - Eksternal".to_string();
                            } else {
